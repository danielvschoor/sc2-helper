...
def generate(file=r"C:\Users\danie\Documents\StarCraft II\stableid.json"):
    to_generate = ["AbilityId", "UnitTypeId", "BuffId", "EffectId", "UpgradeId"]
    map_data_to_id = {"AbilityId": "Abilities", "UnitTypeId": "Units", "BuffId": "Buffs", "EffectId": "Effects",
                      "UpgradeId": "Upgrades"}
